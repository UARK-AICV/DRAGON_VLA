...
description: OBEYED-VLA improves clutter-robust robotic manipulation by grounding vision-language-action models with task-conditioned object-centric and geometry-aware observations.
